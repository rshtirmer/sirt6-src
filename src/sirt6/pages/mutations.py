...
___
 ...
 3. Human Perinatal Lethality Syndrome
 4. Lymphopenia with Severe Metabolic Defects
 5. Cancers

# Major Mutations
___
While there is not much information noted about mutations associated with SIRT6, one study found individuals with either the CC or CT genotype at rs107251 within SIRT6 to display greater than 5-year mean survival advantages as compared to the TT genotype.

When cells were depleted of SIRT6, they exhibited abnormal telomere structures that resemble defects observed in Werner syndrome, a premature aging disorder. At telomeric chromatin, SIRT6 deacetylates H3K9 and is required for the stable association of WRN, the factor that is mutated in Werner syndrome
...
While previously shown under Protein Function, this diagram gives a good representation of SIRT6 and its influence on tumor growth.
''')
