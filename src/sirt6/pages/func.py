...
The diagram above shows SIRT6 as a histone deacetylase that promotes DNA repair.  SIRT6 helps regulate Tau protein stability and phosphorylation by increasing the activation of kinase GSK3α/β.

# Major Biological Pathways
___
 1. Removal of long-chain fatty acyl groups from lysine residues
 2. DNA Repair
 3. Glycolysis
 4. Gluconeogenesis
 5. Tumorigenesis
 6. Neurodegeneration
 7. Cardiac Hypertrophic Responses
 8. Gene Expression
 9. Apoptosis
...
As previously stated, SIRT6 functions as a histone H3K9 deacetylase.  This controls the expression of many glycolytic genes. It is noted that SIRT6 appears to function as a corepressor of the transcription factor Hif1α.  This transcription factor is a very important regulator of the nutrient stress responses.  When there is lower amounts of SIRT6, Hif1α activity is increased.  This leads to higher levels of glucose uptake with up-regulation of glycolysis and lower mitochondrial respiration. Studies have also shown that lack of SIRT6 led to an increase in serum lactate, further supporting its role in glucose uptake regulation and a glycolytic switch.
...
___
SIRT6 is a predominantly nuclear protein. This is associated mostly with telomeric heterochromatin regions, having a strong association with DNA repair and regulation of telomeric chromatin.

# Protein Interactions
___
SIRT6 has many protein interactions, functioning in DNA repair, cell cycle regulation, and NF-kB transcription.  The top 5 proteins that SIRT6 is known to interact with include: CHD3, MYC, RELA, AHR, and AKT1
...
AKT1: This protein is a serine/threonine-protein kinase responsible for regulating many processes.  This includes metabolism, proliferation, cell survival, growth and angiogenesis.
''')
